...
> **Retrieval Practice:** Before continuing to ANOVA, try to recall from the T-test session:
> - What is the difference between t-test and ANOVA?
> - When do we use t-test vs ANOVA?
> - What does the null hypothesis test in ANOVA?
...
**Question:** Which post-hoc test is most appropriate?
- A) Tukey HSD
- B) Dunnett
- C) Bonferroni
- D) No post-hoc needed
...
**Interpretation:**
- If ANOVA p-value < 0.05 → there is a difference between locations
- If Bonferroni p-value < 0.05 → those location pairs differ significantly


The output shows pairwise comparisons with p-values adjusted using the Bonferroni method.

> **Tukey vs. Bonferroni:**
> - **Tukey HSD**: More powerful for *all-pairwise* comparisons (all pairs)
> - **Bonferroni**: More conservative, suitable for *planned comparisons* (pre-planned comparisons)
