...
> **Retrieval Practice:** Sebelum mempelajari Chi-square, coba ingat kembali:
...
> **Hinge Question:** Anda sedang meneliti apakah jenis tanah (lempung, berpasir, liat) mempengaruhi jenis tanaman yang tumbuh (bunga, sayur, pohon). Variabel apa yang kategorikal?
>
> A) Hanya jenis tanah
...
> **Hint Ladder:** Jika Anda bingung cara menghitung Chi-square secara manual:
> - **Hint 1:** Ingat formula: χ² = Σ(O - E)² / E
> - **Hint 2:** Hitung expected frequency: E = (row total × column total) / grand total
> - **Hint 3:** Gunakan `chisq.test()` untuk hasil langsung
